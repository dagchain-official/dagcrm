...
export const RESOURCES = {
  ...
  leads: {
    ...
    columns: [
      ...
      { key: "expected_value", label: "Expected", money: true },
      { key: "assigned_name", label: "Owner" },
      { key: "sla_status", label: "SLA", badge: true },
    ...
    fields: [
      ...
      { key: "campaign", label: "Campaign / reference" },
      { key: "priority", label: "Priority", type: "select", options: sel("low", "medium", "high", "critical") },
      { key: "expected_value", label: "Expected value ($)", type: "number" },
      { key: "probability", label: "Probability (%)", type: "number" },
      { key: "lost_reason", label: "Lost reason (if Closed Lost)" },
  ...
  "training-modules": {
    ...
    columns: [
      { key: "module_id", label: "ID" },
      { key: "title", label: "Title" },
      { key: "category", label: "Category" },
      { key: "audience", label: "Audience" },
      { key: "frequency", label: "Frequency" },
      { key: "pass_mark", label: "Pass %", percent: true },
      { key: "version", label: "Ver" },
      { key: "active", label: "Active", bool: true },
    ],
    fields: [
      { key: "module_id", label: "Module ID (e.g. TR011)", required: true },
      { key: "title", label: "Title", required: true },
      { key: "category", label: "Category" },
      { key: "audience", label: "Audience" },
      { key: "owner", label: "Owner", type: "ref", ref: "employees", labelKey: "user_name" },
      { key: "delivery_mode", label: "Delivery mode" },
      { key: "duration_hours", label: "Duration (hours)", type: "number" },
      { key: "mandatory", label: "Mandatory", type: "select", options: sel("true", "false") },
      { key: "frequency", label: "Frequency (Onboarding/Annual/…)" },
      { key: "pass_mark", label: "Pass mark (0-1, e.g. 0.8)", type: "number" },
      { key: "content_summary", label: "Content summary", type: "textarea" },
      { key: "learning_outcome", label: "Learning outcome", type: "textarea" },
      { key: "version", label: "Version" },
      { key: "active", label: "Active", type: "select", options: sel("true", "false") },
    ],
  },
  "training-assignments": {
    title: "Training Assignments", endpoint: "training-assignments", search: true,
    filters: [
      { key: "employee", label: "Employee", ref: "employees", labelKey: "user_name" },
      { key: "module", label: "Module", ref: "training-modules", labelKey: "title" },
      { key: "status", label: "Status", options: sel("assigned", "in_progress", "completed", "overdue", "exempted") },
    ],
    columns: [
      { key: "employee_name", label: "Employee" },
      ...
      { key: "status", label: "Status", badge: true },
      { key: "latest_score", label: "Score", percent: true },
      { key: "compliance_flag", label: "Compliance", badge: true },
    ],
    fields: [
      { key: "employee", label: "Employee", type: "ref", ref: "employees", labelKey: "user_name", required: true },
      { key: "module", label: "Module", type: "ref", ref: "training-modules", labelKey: "title", required: true },
      { key: "assigned_date", label: "Assigned date", type: "date" },
      { key: "due_date", label: "Due date", type: "date" },
      { key: "status", label: "Status", type: "select", options: sel("assigned", "in_progress", "completed", "overdue", "exempted") },
      { key: "completion_date", label: "Completion date", type: "date" },
      { key: "latest_score", label: "Latest score (0-1)", type: "number" },
      { key: "attempts", label: "Attempts", type: "number" },
      { key: "certificate_expiry", label: "Certificate expiry", type: "date" },
      { key: "manager_comment", label: "Manager comment" },
    ],
  },
  assessments: {
    title: "Assessments", endpoint: "assessments", search: true,
    filters: [
      { key: "employee", label: "Employee", ref: "employees", labelKey: "user_name" },
      { key: "module", label: "Module", ref: "training-modules", labelKey: "title" },
      { key: "result", label: "Result", options: sel("pass", "fail") },
    ],
    columns: [
      { key: "employee_name", label: "Employee" },
      { key: "module_title", label: "Module" },
      ...
      { key: "score", label: "Score", percent: true },
    ...
    fields: [
      ...
      { key: "attempt_no", label: "Attempt no.", type: "number" },
      { key: "questions", label: "Questions", type: "number" },
      { key: "correct_answers", label: "Correct answers", type: "number" },
      { key: "score", label: "Score (0-1)", type: "number" },
      { key: "pass_mark", label: "Pass mark (0-1)", type: "number" },
      { key: "knowledge_gap", label: "Knowledge gap" },
      { key: "retest_due", label: "Retest due", type: "date" },
      { key: "assessor", label: "Assessor", type: "ref", ref: "employees", labelKey: "user_name" },
  ...
  attendance: {
    ...
    columns: [
      ...
      { key: "status", label: "Status", badge: true },
      { key: "checkin_map", label: "Check-in location", mapLink: true },
    ],
    fields: [
      { key: "employee", label: "Employee", type: "ref", ref: "employees", labelKey: "user_name", required: true },
  ...
  "employee-documents": {           // Document Vault
    title: "Document Vault", endpoint: "employee-documents", search: true, permModule: "employees",
    filters: [
      { key: "employee", label: "Employee", ref: "employees", labelKey: "user_name" },
      { key: "doc_type", label: "Type", options: sel("passport", "visa", "emirates_id", "contract", "offer_letter", "certificate", "insurance", "other") },
      { key: "verified", label: "Verified", options: sel("true", "false") },
    ],
    columns: [
      { key: "employee_name", label: "Employee" },
      ...
      { key: "verified", label: "Verified", bool: true },
    ],
    fields: [
      { key: "employee", label: "Employee", type: "ref", ref: "employees", labelKey: "user_name", required: true },
      { key: "doc_type", label: "Document type", type: "select", options: sel("passport", "visa", "emirates_id", "contract", "offer_letter", "certificate", "insurance", "other"), required: true },
      { key: "title", label: "Title / label" },
      { key: "number", label: "Document number" },
      { key: "file", label: "File (PDF / image)", type: "file", accept: ".pdf,image/*" },
      { key: "issue_date", label: "Issue date", type: "date" },
      { key: "expiry_date", label: "Expiry date", type: "date" },
      { key: "verified", label: "Verified", type: "select", options: sel("true", "false") },
      { key: "notes", label: "Notes", type: "textarea" },
    ],
  },
  "employee-events": {              // Employee Timeline
    title: "Employee Timeline", endpoint: "employee-events", search: true, permModule: "employees",
    filters: [
      { key: "employee", label: "Employee", ref: "employees", labelKey: "user_name" },
      { key: "kind", label: "Type", options: sel("join", "promotion", "transfer", "appraisal", "pip", "warning", "recognition", "training", "exit", "note") },
    ],
    columns: [
      { key: "date", label: "Date" },
      { key: "employee_name", label: "Employee" },
      { key: "kind_display", label: "Type", badge: true },
      { key: "title", label: "Event" },
      { key: "details", label: "Details" },
    ],
    fields: [
      { key: "employee", label: "Employee", type: "ref", ref: "employees", labelKey: "user_name", required: true },
      { key: "kind", label: "Type", type: "select", options: sel("join", "promotion", "transfer", "appraisal", "pip", "warning", "recognition", "training", "exit", "note"), required: true },
      { key: "date", label: "Date", type: "date", required: true },
      { key: "title", label: "Title", required: true },
  ...
  "performance-journal": {          // Performance Journal
    title: "Performance Journal", endpoint: "performance-journal", search: true, permModule: "employees",
    filters: [
      { key: "employee", label: "Employee", ref: "employees", labelKey: "user_name" },
      { key: "kind", label: "Type", options: sel("win", "coaching", "concern", "note") },
    ],
    columns: [
      { key: "date", label: "Date" },
      { key: "employee_name", label: "Employee" },
      ...
      { key: "note", label: "Note" },
      { key: "author_name", label: "By" },
    ],
    fields: [
      { key: "employee", label: "Employee", type: "ref", ref: "employees", labelKey: "user_name", required: true },
      { key: "date", label: "Date", type: "date", required: true },
      { key: "kind", label: "Type", type: "select", options: sel("win", "coaching", "concern", "note"), required: true },
  ...
  appraisals: {                     // Appraisal Engine
    ...
    fields: [
      { key: "employee", label: "Employee", type: "ref", ref: "employees", labelKey: "user_name", required: true },
      { key: "period", label: "Period (e.g. Annual 2025)", required: true },
      { key: "self_review", label: "Self review", type: "textarea" },
      { key: "self_rating", label: "Self rating (1-5)", type: "number" },
      { key: "manager_review", label: "Manager review", type: "textarea" },
      { key: "manager_rating", label: "Manager rating (1-5)", type: "number" },
      { key: "increment_pct", label: "Increment %", type: "number" },
      { key: "promotion_to", label: "Promotion to (designation)" },
      { key: "status", label: "Status", type: "select", options: sel("self", "manager", "approved", "closed") },
    ],
  },
  pips: {                           // PIP Management
    title: "Improvement Plans (PIP)", endpoint: "pips", search: true, permModule: "employees",
    filters: [
      { key: "employee", label: "Employee", ref: "employees", labelKey: "user_name" },
      { key: "status", label: "Status", options: sel("active", "passed", "failed", "cancelled") },
    ],
    columns: [
      { key: "employee_name", label: "Employee" },
      { key: "reason", label: "Reason" },
    ...
    fields: [
      ...
      { key: "goals", label: "Goals / expectations", type: "textarea" },
      { key: "start_date", label: "Start date", type: "date" },
      { key: "end_date", label: "Review by", type: "date" },
      { key: "review_notes", label: "Review notes", type: "textarea" },
      { key: "status", label: "Status", type: "select", options: sel("active", "passed", "failed", "cancelled") },
    ],
  },
  "employee-exits": {               // Exit Management
    title: "Exit Management", endpoint: "employee-exits", search: true, permModule: "employees",
    filters: [
      { key: "employee", label: "Employee", ref: "employees", labelKey: "user_name" },
      { key: "status", label: "Status", options: sel("initiated", "clearance", "completed", "cancelled") },
    ],
    columns: [
      { key: "employee_name", label: "Employee" },
      { key: "resignation_date", label: "Resigned" },
      { key: "last_working_day", label: "Last day" },
      { key: "reason", label: "Reason" },
      { key: "clearance_it", label: "IT", bool: true },
      { key: "clearance_finance", label: "Finance", bool: true },
      { key: "clearance_hr", label: "HR", bool: true },
      { key: "status", label: "Status", badge: true },
    ],
    fields: [
      { key: "employee", label: "Employee", type: "ref", ref: "employees", labelKey: "user_name", required: true },
      ...
      { key: "reason", label: "Reason" },
      { key: "clearance_it", label: "IT cleared", type: "select", options: sel("true", "false") },
      { key: "clearance_finance", label: "Finance cleared", type: "select", options: sel("true", "false") },
      { key: "clearance_hr", label: "HR cleared", type: "select", options: sel("true", "false") },
      { key: "exit_interview", label: "Exit interview notes", type: "textarea" },
      { key: "notes", label: "Notes", type: "textarea" },
      { key: "status", label: "Status", type: "select", options: sel("initiated", "clearance", "completed", "cancelled") },
    ],
  },
  "hr-tickets": {                   // HR Helpdesk (self-service)
    ...
    filters: [
      { key: "category", label: "Category", options: sel("leave", "payroll", "visa", "it", "grievance", "benefits", "other") },
      { key: "status", label: "Status", options: sel("open", "in_progress", "resolved", "closed") },
      { key: "priority", label: "Priority", options: sel("low", "medium", "high", "urgent") },
    ],
    columns: [
      ...
      { key: "priority", label: "Priority", badge: true },
      { key: "status", label: "Status", badge: true },
      { key: "assigned_to_name", label: "Handled by" },
      { key: "created_at", label: "Raised", datetime: true },
    ],
    fields: [
      { key: "category", label: "Category", type: "select", options: sel("leave", "payroll", "visa", "it", "grievance", "benefits", "other"), required: true },
      { key: "subject", label: "Subject", required: true },
      { key: "description", label: "Describe your issue", type: "textarea" },
      { key: "priority", label: "Priority", type: "select", options: sel("low", "medium", "high", "urgent") },
      { key: "resolution", label: "Resolution (HR)", type: "textarea" },
  ...
  policies: {                       // Policy Centre (read + e-sign)
    ...
    filters: [
      { key: "category", label: "Category", options: sel("hr", "it", "finance", "compliance", "code_of_conduct", "other") },
    ],
    columns: [
      { key: "title", label: "Policy" },
      { key: "category_display", label: "Category" },
      { key: "version", label: "Ver" },
      { key: "file", label: "Document", link: true, linkLabel: "PDF" },
      { key: "ack_count", label: "Signed by" },
      { key: "my_ack", label: "I signed", bool: true },
    ],
    fields: [
      { key: "title", label: "Title", required: true },
      { key: "category", label: "Category", type: "select", options: sel("hr", "it", "finance", "compliance", "code_of_conduct", "other"), required: true },
      { key: "version", label: "Version" },
  ...
  recognitions: {                   // Recognition wall (peer nomination)
    ...
    filters: [
      { key: "award", label: "Award", options: sel("kudos", "star", "team_player", "innovation", "milestone", "spot") },
      { key: "status", label: "Status", options: sel("pending", "approved", "rejected") },
    ],
    columns: [
      { key: "employee_name", label: "Recognised" },
      { key: "award_display", label: "Award" },
      { key: "reason", label: "Reason" },
      { key: "points", label: "Points" },
      { key: "nominated_by_name", label: "Nominated by" },
      { key: "status", label: "Status", badge: true },
    ],
    fields: [
      { key: "employee", label: "Recognise (employee)", type: "ref", ref: "employees", labelKey: "user_name", required: true },
      { key: "award", label: "Award", type: "select", options: sel("kudos", "star", "team_player", "innovation", "milestone", "spot"), required: true },
