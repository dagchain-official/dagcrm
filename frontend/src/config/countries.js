// All country names + dialing codes — used for the Country dropdown in Lead/Customer
// forms, and to auto-fill the phone field with the selected country's code.
...
export const COUNTRIES = Object.keys(COUNTRY_DIAL);

// Ready-to-use options for the DataForm "select" field type.
export const COUNTRY_OPTIONS = COUNTRIES.map((c) => ({ value: c, label: `${c} (${COUNTRY_DIAL[c]})` }));
