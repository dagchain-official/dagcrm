...
urlpatterns = [
    ...
    path("reports/company-health/", views.company_health),
    path("reports/settings/", views.company_settings),
    ...
    path("reports/team-pnl/", views.team_pnl),
    ...
    path("reports/commission-rules/", views.commission_rules),
